// "use client":This is a Next.js 13+ directive, indicating that this component (Hero) should be rendered on the client-side.
//  This is necessary because: framer-motion animations run in the browser, Interactivity (like button clicks) only works on the client side.
"use client";


// import Link from "next/link": Link is used for internal page navigation in Next.js.
//  It's better than <a> for performance and client-side routing. to install next, run npm install next
import Link from "next/link";


// import { easeInOut, motion } from "framer-motion": motion is used to create animated elements and 
// easeInOut is an easing function for smooth animations. to install framer-motion, run npm install framer-motion
import { easeInOut, motion } from "framer-motion";

// import { ArrowRight } from "lucide-react": This imports an SVG icon component for use in buttons/links.
// to install lucide-react, run npm install lucide-react
import { ArrowRight } from "lucide-react";

// import { heroStats, highlightTags, workflowItems } from "../lib/content": These are predefined
//  arrays of data used to dynamically render stats, tags, and workflow items.
import { heroStats, highlightTags, workflowItems } from "../lib/content";


//The Hero component accepts one optional prop: onOpenContact: a function callback that is called when 
// the “Let’s Connect” button is clicked. The ? makes it optional.
type HeroProps = {
  onOpenContact?: () => void;
};
      ...
      <div className="max-w-7xl mx-auto px-6 relative grid gap-12 lg:grid-cols-[1.2fr,0.8fr] items-center">
        ...
        >
          <div
            ...
            aria-hidden
          />
            {/*block Hero stats and workflow items */}
